...
class EnrichTeamMembersWithBackgroundStory:
    ...
    def execute(cls, llm: LLM, user_prompt: str, team_member_list: list[dict]) -> 'EnrichTeamMembersWithBackgroundStory':
        ...
        try:
            ...
            raw_response = require_raw(chat_response, TeamDetails)
        ...
        team_member_list_enriched = cls.cleanup_enriched_team_members_and_merge_with_team_members(raw_response, team_member_list)
